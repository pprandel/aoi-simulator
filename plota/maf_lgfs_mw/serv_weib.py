...
# Load data
data_files = ["resultados/maf_lgfs_mw_preemption_weib.json", "resultados/maf_lgfs_preemption_weib.json", 
"resultados/masif_lgfs_no_preemption_weib.json", "resultados/normal_lgfs_preemption_weib.json"]
