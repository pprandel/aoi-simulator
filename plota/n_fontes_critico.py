...
# Load data
data_file_1 = "resultados/multi_lgfs_preemption_exp.json"

x = []
m_aoi = []
m_p_aoi = []

with open (data_file_1, 'r') as d:
        data = json.load(d)
...
ax.axhline(y=5, color='indigo', linestyle='--', label="Limite AoI médio")
ax.axhline(y=8, color='tomato', linestyle='--', label="Limite AoI de pico médio")
