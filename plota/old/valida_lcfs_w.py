...
ax[0].set_title('AoI médio para a fila M/M/1/2*')
ax[0].legend()
ax[0].grid(True)

data_file = "resultados/analit_md1_lcfs_w_aoi.txt"
with open (data_file, 'r') as d:
        data = d.read()
        data = ast.literal_eval(data)
...
data_file = "resultados/sim_md1_lcfs_w_aoi.txt"
with open (data_file, 'r') as d:
        data = d.read()
        data = ast.literal_eval(data)
...
ax[1].set_title('AoI médio para a fila M/D/1/2*')
ax[1].legend()
ax[1].grid(True)

data_file = "resultados/analit_dm1_lcfs_w_aoi.txt"
with open (data_file, 'r') as d:
        data = d.read()
        data = ast.literal_eval(data)
...
data_file = "resultados/sim_dm1_lcfs_w_aoi.txt"
with open (data_file, 'r') as d:
        data = d.read()
        data = ast.literal_eval(data)
...
ax[2].set_title('AoI médio para a fila D/M/1/2*')
ax[2].legend()
ax[2].grid(True)
