...
def calc_int_autocor_time(Q):
        ...
        return abs(auto_sum), acorr, true_var
...
data_file = "resultados/aoi_vec_0.txt"
...
alfa, acorr, true_var = calc_int_autocor_time(Q)

var_delta = (26.6/95)**2 * true_var
RMSE = var_delta**0.5
print("RMSE: %f" %RMSE)

fig, ax1 = plt.subplots()
ax2 = ax1.twinx()
ln1 = ax1.plot(aoi, 'mediumblue', label='Estimated mean AoI')
ln2 = ax2.plot(acorr, 'g', label='Autocorr')
